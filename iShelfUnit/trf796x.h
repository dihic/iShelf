...
#define IRQ_CLR 			GPIOIntClear(PIN_RFID_IRQ)
#define IRQ_PIN_HIGH 	GPIOGetValue(PIN_RFID_IRQ)
#define IRQ_ON 				GPIOIntEnable(PIN_RFID_IRQ)
#define IRQ_OFF 			GPIOIntDisable(PIN_RFID_IRQ)
